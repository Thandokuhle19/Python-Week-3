...
class main():
    ...
    def __init__(self):
        ...
        self.email_signup = CTkEntry(self.root, bg_color="#D8BFD8")
        self.style = ttk.Style(self.root)

        self.password_signup1 = CTkEntry(self.root, show="*", bg_color="#D8BFD8")
        self.password_signup2 = CTkEntry(self.root, show="*", bg_color="#D8BFD8")
        ...
        self.lblemail = CTkLabel(self.root, text="Enter your email:", bg_color="#D8BFD8")
        self.lblemail.grid(row = 1, column = 0, padx = 10, pady = 10)

        self.lblupassword = CTkLabel(self.root, text="Enter your password:", bg_color="#D8BFD8")
        self.lblupassword.grid(row = 2, column = 0, padx = 10, pady = 10)
        self.lblupassword2 = CTkLabel(self.root, text="Confirm your password:", bg_color="#D8BFD8")
        ...
        def loggedin():
            ...
            self.top.config(bg="#D8BFD8")
            self.lblemaillog = CTkLabel(self.top, text="Enter your email:", bg_color="#D8BFD8")
            self.lblemaillog.grid(row=1, column=0, padx=10, pady=10)
            self.lblupasswordlog = CTkLabel(self.top, text="Enter your password:", bg_color="#D8BFD8")
            self.lblupasswordlog.grid(row=2, column=0, padx=10, pady=10)
            global email_login
            global password_login
            self.email_login = CTkEntry(self.top, bg_color="#D8BFD8")
            self.password_login = CTkEntry(self.top, show="*", bg_color="#D8BFD8")
        ...
        self.btn = CTkButton(self.root, text="Register", fg_color="red", command=register , bg_color="#D8BFD8")
        # set Button grid
        self.btn.grid(column=1, row=5)
        self.btn_account = CTkButton(self.root, text="Already have an account?", command=loggedin , bg_color="#D8BFD8")
        ...
        def mainmenu():
            ...
            self.menu.config(bg="#D8BFD8")
            self.lbl_learners = CTkLabel(self.menu, text="WELCOME TO THE MARKOHOLIC GRADING SYSTEM", bg_color="#D8BFD8")
            ...
            def view_group_marks(group):
                ...
                self.view_marks_window.config(bg="#D8BFD8")
            ...
            def view_groups():
                ...
                self.groups_window.config(bg="#D8BFD8")
                # Load groups
                groups = load_groups()
            ...
            def addgroupmenu():
                ...
                self.addgroups.config(bg="#D8BFD8")
                    ...
                    with open("groups.csv", mode="a", newline="") as f:
                        ...
                        def addlearners():
                            ...
                            def addmarks():
                                ...
                                self.addmarks.config(bg="#D8BFD8")
